            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-flex bg-login-image justify-content-center align-items-center"> <img width="300" height="auto" src="{{asset('assets/img/Logo-Muhammadiyah-png-warna--300x300.png')}}" alt=""></div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="{{ route('login') }}" method="POST">
                                        ...
                                        <button type="submit" class="btn btn-success btn-user btn-block" style="background-color: #00923F">Login</button>
                                        <hr>
