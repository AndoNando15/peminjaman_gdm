    ...
    <div class="container ">
        <div class="card o-hidden border-0 shadow-lg my-5 ">
            <div class="card-body p-0 ">
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-flex bg-register-image justify-content-center align-items-center">
                        <img width="300" height="auto" src="{{asset('assets/img/Logo-Muhammadiyah-png-warna--300x300.png')}}" alt="">
                    </div>
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="{{ route('register') }}" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" class="form-control form-control-user" name="password_confirmation" id="exampleRepeatPassword" placeholder="Repeat Password" required>
                                    </div>
                                </div>
                                <button type="submit" class="btn btn-success btn-user btn-block" style="background-color: #00923F">Register Account</button>
                                <hr>
